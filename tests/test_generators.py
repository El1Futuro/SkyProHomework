...
def test_card_number_generator():
    ...
    assert next(card_generator) == "0000 0000 0000 0006"
    assert next(card_generator) == "0000 0000 0000 0007"
    assert next(card_generator) == "0000 0000 0000 0008"
    assert next(card_generator) == "0000 0000 0000 0009"
    assert next(card_generator) == "0000 0000 0000 0010"
